...
const errorLabels: Record<string, string> = {
  ...
  "Could not create observer ticket": "無法建立主持後台票券。",
  "Could not open host observer.": "無法開啟主持後台。",
  "Observer connection rejected.": "主持後台連線被拒絕。",
  "Reset failed": "重設房間失敗。",
  ...
  "Invalid or expired observer ticket": "主持後台票券無效或已過期。",
  "Spectators cannot act": "觀戰者不能執行操作。",
  "Host observers cannot act": "主持後台不能執行玩家操作。",
  "Only the host can open host observer": "只有專職主持可以開啟主持後台。",
  "Player-host rooms cannot reveal hidden information": "此房間為玩家房主模式，房主不可查看隱藏資訊。",
  "Dedicated host token missing": "缺少專職主持憑證。",
  "Too many observer tickets. Try again soon.": "主持後台連線請求過多，請稍後再試。",
  "Host changed. Host observer closed.": "主持權已轉移，主持後台已中止。",
  "Dedicated host rooms cannot transfer host to a player": "專職主持房間不能把主持權轉給玩家。",
