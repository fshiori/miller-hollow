...
const errorLabels: Record<string, string> = {
  ...
  "Could not create observer ticket": "無法建立主持觀戰票券。",
  "Could not open host observer.": "無法開啟主持觀戰。",
  "Observer connection rejected.": "主持觀戰連線被拒絕。",
  "Reset failed": "重設房間失敗。",
  ...
  "Invalid or expired observer ticket": "主持觀戰票券無效或已過期。",
  "Spectators cannot act": "觀戰者不能執行操作。",
  "Host observers cannot act": "主持觀戰不能執行玩家操作。",
  "Only the host can open host observer": "只有房主可以開啟主持觀戰。",
  "Too many observer tickets. Try again soon.": "主持觀戰連線請求過多，請稍後再試。",
  "Host changed. Host observer closed.": "主持權已轉移，主持觀戰已中止。",
