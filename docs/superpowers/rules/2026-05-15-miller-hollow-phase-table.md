...
| `day_vote` | Day Vote | Living players vote; dedicated host can trigger paced AI votes in demo rooms | Missing votes become abstentions | Next night, reaction phase, or `ended` |
