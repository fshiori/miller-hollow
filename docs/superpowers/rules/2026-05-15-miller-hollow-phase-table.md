...
| `day_discussion` | Day Discussion | Living players chat and mark ready; host may open Sheriff election in V5 roleflow; AI test players can chat/ready by host command | Advance to vote | `day_vote` or `sheriff_election` |
| `sheriff_election` | Sheriff Election | Living players vote | Missing votes become abstentions | `day_discussion` |
| `day_vote` | Day Vote | Living players vote; AI test players can vote by host command | Missing votes become abstentions | Next night, reaction phase, or `ended` |
